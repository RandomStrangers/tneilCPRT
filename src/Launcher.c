...
const struct LauncherTheme Launcher_CoreTheme = {
	false,
	BitmapColor_RGB(191, 255, 245), /* background */
	BitmapColor_RGB(0, 75, 223), /* button border */
	BitmapColor_RGB(100, 147, 255), /* active button */
	BitmapColor_RGB(191, 255, 191), /* button */
	BitmapColor_RGB(191, 255, 255), /* button highlight*/
};
...
void Launcher_DrawTitle(struct FontDesc* font, const char* text, struct Context2D* ctx) {
	cc_string title = String_FromReadonly("&a(ateB) &dy&2n&7o&0m&5r&6a&4H");
